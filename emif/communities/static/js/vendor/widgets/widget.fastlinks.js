/*
    ...
    #
*/
var FastLinksWidget = function FastLinksWidget(widgetname, width, height, pos_x, pos_y){

    FastLinksWidget._base.apply(this, [widgetname, "Actions", width, height, pos_x, pos_y]);
    ...
    __init : function(gridster, parent){
        ...
        FastLinksWidget._super.__init.apply(self, [gridster, parent]);
